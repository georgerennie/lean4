...
/-- info: #["_private.Lean.MetavarContext.0.Lean.MetavarContext.MkBinding.elimMVar",
  ...
  "Lean.computeStructureResolutionOrder._redArg._lam_15",
  "Lean.computeStructureResolutionOrder.selectParent._redArg._lam_6", "Lean.Meta.evalNat",
  ...
  "Lean.Elab.mkDeclName._at_.Lean.Elab.expandDeclId._at_.Lean.Elab.Term.expandDeclId.spec_0.spec_1._lam_2",
  ...
  "Lean.Elab.elabTerminationHints._at_._private.Lean.Elab.LetRec.0.Lean.Elab.Term.mkLetRecDeclView.spec_4._lam_3",
  "Lean.Elab.elabTerminationHints._at_._private.Lean.Elab.LetRec.0.Lean.Elab.Term.mkLetRecDeclView.spec_4._lam_9",
